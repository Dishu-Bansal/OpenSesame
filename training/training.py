...
if __name__ == "__main__":
    ...
    joblib.dump(score_rescaler, f'score_rescaler_{new_version}.pkl')
    joblib.dump(model, f'lgbm_model_{new_version}.pkl') # Save your LightGBM model
    joblib.dump(global_one_hot_encoder, f'one_hot_encoder_{new_version}.pkl') # Save your encoder
    joblib.dump(trained_feature_columns, f'calls_list_{new_version}.joblib')
